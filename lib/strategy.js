 ...
 * @api public
 */
function NiftyStrategy(options, verify) {
...
util.inherits(NiftyStrategy, passport.Strategy);
 ...
 * @api protected
 */
NiftyStrategy.prototype.authenticate = function(req, options) {
  options = options || {};
  var self = this;
 ...
 * @api protected
 */
NiftyStrategy.prototype.userProfile = function(accessToken, done) {
  return done(null, {});
};
 ...
 * @api protected
 */
NiftyStrategy.prototype.authorizationParams = function(options) {
  return {};
};
 ...
 * @api protected
 */
NiftyStrategy.prototype.tokenParams = function(options) {
  return {};
};
 ...
 * @api protected
 */
NiftyStrategy.prototype.parseErrorResponse = function(body, status) {
 ...
 * @api private
 */
NiftyStrategy.prototype._loadUserProfile = function(accessToken, done) {
  var self = this;
 ...
 * @api private
 */
NiftyStrategy.prototype._createOAuthError = function(message, err) {
  var e;
